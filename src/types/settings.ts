...
export type LessonPageSettings = {
  hero: { eyebrow: string; title: string; description: string; primaryCtaLabel: string; primaryCtaPath: string; secondaryCtaLabel: string; secondaryCtaPath: string; imageUrl: string; visualLabel: string; visualDescription: string }
}
